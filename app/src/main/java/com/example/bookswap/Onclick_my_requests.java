...
public class Onclick_my_requests extends AppCompatActivity {
    ...
    TextView title, author, isbn, genre, user, phone, email, not_delivered;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_onclick_my_requests);
        ...
        not_delivered = findViewById(R.id.not_delivered_text_view);
        database = FirebaseFirestore.getInstance();
        Intent i = getIntent();
        Book_key = i.getStringExtra("bookkey");
        tag = i.getStringExtra("tag");
        delivered = i.getBooleanExtra("delivered", false);
        if(tag.equals("not accepted"))
        {
            Cancel.setVisibility(View.VISIBLE);
            Received.setVisibility(View.GONE);
            not_delivered.setVisibility(View.GONE);
        }
        else if(tag.equals("not delivered"))
        {
            Cancel.setVisibility(View.GONE);
            Received.setVisibility(View.GONE);
            not_delivered.setVisibility(View.VISIBLE);
        }
...
//                    genre.setText(Book_Genres);
                        ...
                        .addOnSuccessListener(aVoid -> {
                            database.collection("users")
                                    ...
                                    .addOnSuccessListener(aVoid2 -> {
                                        Toast.makeText(Onclick_my_requests.this, "Request cancelled successfully!", Toast.LENGTH_SHORT).show();
                                        Intent refresh = new Intent(Onclick_my_requests.this, MyRequestActivity.class);
                                        refresh.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NO_ANIMATION);
                                        startActivity(refresh);
                                        Intent intent = new Intent(Onclick_my_requests.this, LibraryActivity.class);
                                        startActivity(intent);
                                        finish();
                                    })
                                    .addOnFailureListener(e -> {
                                        Toast.makeText(Onclick_my_requests.this, "Failed to decline book " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                    });
                        })
                        .addOnFailureListener(e -> {
                            Toast.makeText(Onclick_my_requests.this, "Failed to decline book " + e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        Received.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (delivered) {
                    progressDialog = new ProgressDialog(Onclick_my_requests.this);
                    ...
                    database.collection("users")
                                                                        ...
                                                                        .addOnSuccessListener(avoid4 -> {
                                                                            ...
                                                                            image1Ref.delete()
                                                                                        ...
                                                                                        public void onSuccess(Void aVoid5) {
                                                                                            ...
                                                                                            image2Ref.delete()
                                                                                                        ...
                                                                                                        public void onSuccess(Void aVoid6) {
                                                                                                            ...
                                                                                                            image3Ref.delete()
                                                                                                                            ...
                                                                                                                            batch.commit()
                                                                                                                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                                                                        ...
                                                                                                                                        public void onSuccess(Void aVoid8) {
                                                                                                                                            ...
                                                                                                                                            Toast.makeText(Onclick_my_requests.this, "Book marked as received!", Toast.LENGTH_SHORT).show();
                                                                                                                                            Toast.makeText(Onclick_my_requests.this, "Your credits updated successfully!", Toast.LENGTH_SHORT).show();
                                                                                                                                            Intent refresh = new Intent(Onclick_my_requests.this, MyRequestActivity.class);
                                                                                                                                            refresh.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NO_ANIMATION);
                                                                                                                                            startActivity(refresh);
                                                                                                                                            Intent refresh2 = new Intent(Onclick_my_requests.this, LibraryActivity.class);
                                                                                                                                    ...
                                                                                                                                    .addOnFailureListener(new OnFailureListener() {
                                                                                                                                        ...
                                                                                                                                        public void onFailure(@NonNull Exception e) {
                                                                                                                                            Toast.makeText(Onclick_my_requests.this, "Failed to remove the book from my requests of the requester: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                                                                                                                        }
                                                                                                                                    });
                                                                                                                        }
                                                                                                                    ...
                                                                                                                    .addOnFailureListener(new OnFailureListener() {
                                                                                                                        @Override
                                                                                                                        public void onFailure(@NonNull Exception e) {
                                                                                                                            Toast.makeText(Onclick_my_requests.this, "Failed to delete Image_3: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                                                                                                        }
                                                                                                                    });
                                                                                                        }
                                                                                                    })
                                                                                                    .addOnFailureListener(new OnFailureListener() {
                                                                                                        @Override
                                                                                                        public void onFailure(@NonNull Exception e) {
                                                                                                            Toast.makeText(Onclick_my_requests.this, "Failed to delete Image_2: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                                                                                        }
                                                                                                    });
                                                                                        }
                                                                                    })
                                                                                    .addOnFailureListener(new OnFailureListener() {
                                                                                        @Override
                                                                                        public void onFailure(@NonNull Exception e) {
                                                                                            Toast.makeText(Onclick_my_requests.this, "Failed to delete Image_1: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                                                                        }
                                                                                    });
                                                                        })
                                                                        .addOnFailureListener(e -> {
                                                                            // Failed to remove book key from user's mybooks array
                                                                            Toast.makeText(Onclick_my_requests.this, "Failed to remove book key from mybooks array: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                                                        });
                                                            })
                                                            .addOnFailureListener(e -> {
                                                                // Failed to delete the book from the database
                                                                Toast.makeText(Onclick_my_requests.this, "Failed to delete book: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                                            });
                                                }
                                            })
                                            .addOnFailureListener(new OnFailureListener() {
                                                @Override
                                                public void onFailure(@NonNull Exception e) {
                                                    Toast.makeText(Onclick_my_requests.this, "Failed to update credits for requester: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                                }
                                            });
                                }
                            })
                            .addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(Onclick_my_requests.this, "Failed to update credits for book owner: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            });
                }
                else
                {
                    database.collection("books")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                @Override
                                public void onSuccess(Void aVoid) {
                                    Toast.makeText(Onclick_my_requests.this, "Book marked as received successfully!", Toast.LENGTH_SHORT).show();
                                    Toast.makeText(Onclick_my_requests.this, "Waiting for the book owner's delivery confirmation!", Toast.LENGTH_LONG).show();
                                    Intent refresh = new Intent(Onclick_my_requests.this, MyRequestActivity.class);
                                    refresh.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NO_ANIMATION);
                                    startActivity(refresh);
                                    Intent intent = new Intent(Onclick_my_requests.this, LibraryActivity.class);
                            ...
                            .addOnFailureListener(new OnFailureListener() {
                                @Override
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(Onclick_my_requests.this, "Failed to mark book as delivered: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                }
                            });
                }
            }
